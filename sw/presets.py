...
BUILTIN_PRESETS = {
    ...
    "dev": {
        ...
        "prompt": (
            ...
            "exécutée par un agent de code en mode agentique.\n\n"
            ...
            "5. **Stratégie d'exécution** : Selon la complexité, ajouter la directive adaptée :\n"
            "   - tâche frontend/UI/design : demander l'usage du skill de design d'interface\n"
            "   - tâche complexe, multi-fichiers, à forte exigence de rigueur : demander une "
            "équipe d'agents (un coordinateur, un expert par sous-tâche, un agent qualité qui "
            "valide chaque livraison)\n"
            "   - tâche simple : rester en agent unique, sans surcouche\n\n"
            "DIRECTIVES À INCLURE EN FIN D'INSTRUCTION :\n"
            ...
            "- Choisir l'approche la plus simple et maintenable\n"
            "- Ne faire que ce qui est demandé, pas de refactoring non sollicité\n\n"
            "RÈGLES :\n"
