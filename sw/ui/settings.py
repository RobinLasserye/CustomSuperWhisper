...
class SettingsDialog(QDialog):
    ...
    def _build_general_tab(self):
        ...
        self.device_metrics_check = QCheckBox("Mesurer CPU, RAM et GPU pendant chaque exécution")
        self.device_metrics_check.setChecked(self.config.get("device_metrics_enabled", True))
        self.device_metrics_check.setEnabled(self.history_check.isChecked())
        self.history_check.toggled.connect(self.device_metrics_check.setEnabled)
        history_layout.addWidget(self.device_metrics_check)
    ...
    def _save(self):
        ...
        self.config["device_metrics_enabled"] = self.device_metrics_check.isChecked()
